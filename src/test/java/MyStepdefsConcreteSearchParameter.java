...
public class MyStepdefsConcreteSearchParameter {
  ...
  @Dann(
      "soll der Suchparameter die Abfrage, ob ein Buch nach dem \"{datum}\" ausgeliehen wurde, enthalten")
  public void sollDerSuchparameterDieAbfrageObEinBuchNachDemAusgeliehenWurdeEnthalten(
      LocalDate arg0) {
  ...
  @Dann(
      "soll der Suchparameter die Zahl {int} als Menge wie oft ein Buch mindestens ausgeliehen wurde enthalten")
  public void sollDerSuchparameterDieZahlAlsMengeWieOftEinBuchMindestensAusgeliehenWurdeEnthalten(
      int arg0) {
  ...
  @Dann(
      "soll der Suchparameter die Zahl {int} als Menge wie oft ein Buch maximal ausgeliehen wurde enthalten")
  public void sollDerSuchparameterDieZahlAlsMengeWieOftEinBuchMaximalAusgeliehenWurdeEnthalten(
      int arg0) {
  ...
  public void sollDerSuchparameterFolgendeWerteEnthalten(DataTable arg0) {
    ...
    for (Map<String, String> row : arg0.asMaps(String.class, String.class)) {
      ...
      if (row.get("borrowedAfter") != null)
        borrowedAfter =
            LocalDate.parse(row.get("borrowedAfter"), DateTimeFormatter.ofPattern("dd.MM.yyyy"));
      if (row.get("boughtBefore") != null)
        boughtBefore =
            LocalDate.parse(row.get("boughtBefore"), DateTimeFormatter.ofPattern("dd.MM.yyyy"));
      if (row.get("boughtAfter") != null)
        boughtAfter =
            LocalDate.parse(row.get("boughtAfter"), DateTimeFormatter.ofPattern("dd.MM.yyyy"));
